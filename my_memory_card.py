...
question_list.append(Question('Самая большая страна по площади', 'Россия', 'Канада', 'США', 'Австралия'))
question_list.append(Question('Год рождения А. С. Пушкина', '1799', '1837', '1800', '2007'))
question_list.append(Question('Самый богатый человек в мире на данный момент', 'Джефф Безос', 'Илон Маск', 'Билл Гейтс', 'Марк Цукерберг'))
question_list.append(Question('Самый маленький город в Росии по населению', 'Приморск', 'Островной', 'Плёс', 'Курильск'))
app = QApplication([])
